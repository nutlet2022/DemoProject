...
--%>
<%@ page import="com.movie.entity.Movie" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="search-box">
                                <form name="movies" method="post" action="movies">
                                    <input class="search-input" placeholder="关键词" type="search" id="search" name="keyword">
                            ...
                            <div class="card-header">
                                <table >
                                    <tr>
                                        ...
                                        <td style="width:600px;" align="center">标题</td>
                                        <td style="width:600px;" align="center">风格</td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <div class="inbox_chat">
                                    ...
                                    <table border="1">
                                        ...
                                        <tr align="center">
                                            ...
                                            <td style="width:600px;"><%=movie.getTitle()%></td>
                                            <td style="width:600px;"><%=movie.getGenres()%></td>
                                        </tr>
                                        <%
                                                }
                                            }
